...
document.getElementById('sortNameAsc').addEventListener('click', () => {
    const sortedData = [...dataSet].sort(sortByName('asc'));
    displayStaffData(sortedData);
});

document.getElementById('sortNameDesc').addEventListener('click', () => {
    const sortedData = [...dataSet].sort(sortByName('desc'));
    displayStaffData(sortedData);
});

document.getElementById('sortSalaryAsc').addEventListener('click', () => {
    const sortedData = [...dataSet].sort(sortBySalary('asc'));
    displayStaffData(sortedData);
});

document.getElementById('sortSalaryDesc').addEventListener('click', () => {
    const sortedData = [...dataSet].sort(sortBySalary('desc'));
    displayStaffData(sortedData);
});

// Initial display
displayStaffData(dataSet);